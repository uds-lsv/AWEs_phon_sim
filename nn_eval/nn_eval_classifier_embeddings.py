...
try:
    ...
    for batch_index, val_batch_dict in enumerate(batch_generator):
        ...
        segment_ID =  val_batch_dict['word_seg_id']

        # for seg_id, emb in zip(segment_ID, acoustic_embs):
        #     segment2vec[seg_id] = emb.cpu().detach().numpy()
    ...
    tau_values = train_utils.compute_kendalls_tau(
        acoustic_vectors,
        acoustic_vectors,
        word2dist,
        index2word
